...
<div class="container-fluid page-body-wrapper">
        <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-image: url(https://images.pexels.com/photos/462030/pexels-photo-462030.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500);background-size: cover">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="admin_task.php">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">Assign Task</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="admin_replytask.php">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">Relpy Task</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="display_leave.php">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">Assign leave</span>
              </a>
            </li>
